...
export function ClientSidebar() {
  ...
  // Dados temporários para teste - SEM HOOKS
  const user = { name: 'Usuário Teste', email: 'teste@teste.com' }
  const company = { nome: 'Empresa Teste', ativa: true, descricao: 'Descrição teste', logo: null }
  const loading = false
  
  // Funções temporárias
  const getTotalProgress = () => 25
  const getCompletedVideosCount = () => 2
  const getTotalVideosCount = () => 8
